          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-card">
            <div className="w-full h-[200px] bg-[#e8e8e8] relative flex items-center justify-center">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <span className="text-[11px] font-semibold text-teal tracking-wide uppercase">Technology</span>
                <h4 className="text-[17px] font-bold text-white leading-snug mt-0.5">
